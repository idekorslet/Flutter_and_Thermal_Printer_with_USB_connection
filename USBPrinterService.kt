...
class USBPrinterService private constructor(private var mHandler: Handler?) {
    ...
    private  var isUSBDetached: Boolean = false
    ...
    private val mUsbDeviceReceiver: BroadcastReceiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context, intent: Intent) {
            ...
            if ((ACTION_USB_PERMISSION == action)) {
                ...
                Log.i(
                    LOG_TAG,
                    "USBPrinterService.kt USB diputus"
                )

                Log.i(
                    LOG_TAG,
                    "USBPrinterService.kt mUsbDevice != null -> ${mUsbDevice != null}"
                )
...
//                }
    ...
    fun closeConnectionIfExists() {
        Log.i(
            LOG_TAG,
            "[USBPrinterService.kt @closeConnectionIfExists] mUsbDeviceConnection == null: ${mUsbDeviceConnection == null}"
        )

        if (mUsbDeviceConnection != null || isUSBDetached) {
            Log.i(
                LOG_TAG,
                "[USBPrinterService.kt @closeConnectionIfExists] isUSBDetached: ${isUSBDetached}"
            )
